...
///Affichage
           ...
           if(minEstime<10)
           {
                std::cout << "  Heure d'arrivee estimee a : " <<heure << "h0"<<  minEstime;
           }
           else
           {
                 std::cout << "  Heure d'arrivee estimee a : " <<heure << "h"<<  minEstime;
           }
            std::cout << std::endl;
            std::cout << std::endl;
            std::cout << "           ------------------------------------------------------------" << std::endl;
...
{
    std::cout << "Tous les sommets ateignables dans l'ordre croissant : ";
    int n = adjList.size();
   ...
   do
   {
    ...
    switch(choix)
    {
        ...
        do
        {
            do
            {
                std::cout <<" Quel est le sommet d'arrivee de votre choix ?"<<std::endl;
                std::cin>> saisieFin;
            }while(saisieFin<1);
        }while(saisieFin>37);
